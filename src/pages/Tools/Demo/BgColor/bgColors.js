export const colors = [
  ...
  {
    name: 'Many colors',
    style: { 'background-color': '#DCD9D4 background-image' },
  },
  {
    name: '#37ecba→#72afd3',
    style: {
  ...
  },
  {
    ...
    style: {
      background:
        'linear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at top center, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.40) 120%) #989898 background-blend-mode',
    },
  },
  {
    name: '#c471f5→#fa71cd',
  ...
  },
  {
    ...
    style: {
      'background-image':
        'linear-gradient(to left, #BDBBBE 0%, #9D9EA3 100%), radial-gradient(88% 271%, rgba(255, 255, 255, 0.25) 0%, rgba(254, 254, 254, 0.25) 1%, rgba(0, 0, 0, 0.25) 100%), radial-gradient(50% 100%, rgba(255, 255, 255, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%) background-blend-mode',
    },
  },
  {
    name: 'Many colors',
  ...
  { name: 'Many colors', style: { background: '#C9CCD3 background-image' } },
  {
    name: '#93a5cf→#e4efe9',
    style: {
  ...
  },
  {
    ...
    style: {
      background:
        'linear-gradient(-180deg, #BCC5CE 0%, #929EAD 98%), radial-gradient(at top left, rgba(255,255,255,0.30) 0%, rgba(0,0,0,0.30) 100%) background-blend-mode',
    },
  },
  {
    name: '#4481eb→#04befe',
  ...
  },
  {
    ...
    style: {
      'background-image':
        'radial-gradient(73% 147%, #EADFDF 59%, #ECE2DF 100%), radial-gradient(91% 146%, rgba(255,255,255,0.50) 47%, rgba(0,0,0,0.50) 100%) background-blend-mode',
    },
  },
  {
    name: '#f794a4→#fdd6bd',
  ...
  {
    name: 'Many colors',
    style: { 'background-color': '#CDDCDC background-image' },
  },
  {
    name: '#209cff→#68e0cf',
    style: {
  ...
  },
  {
    ...
    style: {
      background:
        'linear-gradient(to bottom, #D5DEE7 0%, #E8EBF2 50%, #E2E7ED 100%), linear-gradient(to bottom, rgba(0,0,0,0.02) 50%, rgba(255,255,255,0.02) 61%, rgba(0,0,0,0.02) 73%), linear-gradient(33deg, rgba(255,255,255,0.20) 0%, rgba(0,0,0,0.20) 100%) background-blend-mode',
    },
  },
  {
    name: 'Many colors',
  ...
  },
  {
    ...
    style: {
      background:
        'linear-gradient(to bottom, #323232 0%, #3F3F3F 40%, #1C1C1C 150%), linear-gradient(to top, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.25) 200%) background-blend-mode',
    },
  },
  {
    name: '#00dbde→#fc00ff',
  ...
  {
    name: 'Many colors',
    style: { 'background-color': '#E4E4E1 background-image' },
  },
  {
    name: 'Many colors',
    style: {
